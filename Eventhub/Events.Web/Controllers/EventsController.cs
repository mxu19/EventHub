...
namespace Events.Web.Controllers
{
    ...
    public class EventsController : BaseController 
    {
        ...
        public ActionResult My()
        {
            ...
            var otherEventsImGoingIds = this.db.MyCalendars
            ...
            var otherEvents = allEvents.Where(e => otherEventsImGoingIds.Contains(e.Id));
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AddToCalendarById(int id, EventInputModel model)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult RemoveEventById(int id, EventInputModel model)
        {
            Console.WriteLine("adsfasdf");
            return this.RedirectToAction("My");
        }
